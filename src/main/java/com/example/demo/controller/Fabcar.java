...
public class Fabcar{
    ...
    public static void updateCar() throws Exception {
        ...
        req.setArgs(new String[]{"CAR1", "Marr"});
    ...
    public static void enroll(String username, String password, String certDir) throws Exception {
        ...
        HFCAClient caClient = HFCAClient.createNewInstance("http://192.168.0.105:7054", prop);
    ...
    public static Channel initChannel(HFClient client) throws Exception {
        ...
        channel.addPeer(client.newPeer("peer", "grpc://192.168.0.105:7051"));
        // 指定排序节点地址, 无论是后面执行查询还是更新都必须指定排序节点
        channel.addOrderer(client.newOrderer("orderer", "grpc://192.168.0.105:7050"));
        channel.initialize();
