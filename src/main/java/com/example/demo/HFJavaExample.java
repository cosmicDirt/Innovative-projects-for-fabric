...
public class HFJavaExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HFCAClient caClient = getHfCaClient("http://49.235.226.118:7054", null);
    ...
    static Channel getChannel(HFClient client) throws InvalidArgumentException, TransactionException {
        ...
        Peer peer = client.newPeer("peer1", "grpc://49.235.226.118:7051");
        // Peer peer = client.newPeer("peer1", "grpc://49.235.226.118:8051");

        // eventhub name and endpoint in fabcar network
        //EventHub eventHub = client.newEventHub("eventhub01", "grpc://49.235.226.118:7053");
        // orderer name and endpoint in fabcar network
        Orderer orderer = client.newOrderer("orderer", "grpc://49.235.226.118:7050");
