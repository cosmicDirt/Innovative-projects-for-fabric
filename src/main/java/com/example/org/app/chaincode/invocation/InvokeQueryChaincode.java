...
import com.example.org.app.client.CAClient;
import com.example.org.app.client.ChannelClient;
import com.example.org.app.client.FabricClient;
import com.example.org.app.config.Config;
import com.example.org.app.user.UserContext;
import com.example.org.app.util.Util;
...
public class InvokeQueryChaincode {
	...
	public static void main(String args[]) {
		try {
			...
			EventHub eventHub = fabClient.getInstance().newEventHub("eventhub01", "grpc://49.235.226.118:7053");
